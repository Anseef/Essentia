...
return (
    <SafeAreaView style = {{ flex: 1, backgroundColor: '#f1f4f8' }}>
        ...
        > 
            ...
            <Text style  = {{ fontFamily: "SemiBold",fontSize:32,color: '#836cdd',marginBottom: -10,paddingTop:5}}>Appam</Text>
            ...
            <View style = { styles.NutritionContainer }>
                ...
                <View>
                    <DividerLine/>
                        <NutritionBlock NutritionValue = { 'Calorie' } Measure = { '117kcal' }/>
                    <DividerLine/>
                        <NutritionBlock NutritionValue = { 'Carbs' } Measure = { '11 g' }/>
                        <NutritionBlock NutritionValue = { 'Fiber' } Measure = { '1.3 g' }/>
                        <NutritionBlock NutritionValue = { 'Sugar' } Measure = { '3.6 g' }/>
                    <DividerLine/>
                        <NutritionBlock NutritionValue = { 'Protein' } Measure = { '1.7 g' }/>
                    <DividerLine/>
                        <NutritionBlock NutritionValue = { 'Fat' } Measure = { '7.6 g' }/>
                        <NutritionBlock NutritionValue = { 'Saturated Fat' } Measure = { '1.3 g' }/>
                    <DividerLine/>
                        <NutritionBlock NutritionValue = { 'Cholesterol' } Measure = { '0 mg' }/>
                        <NutritionBlock NutritionValue = { 'Sodium' } Measure = { '145 mg' }/>
                        <NutritionBlock NutritionValue = { 'Potassium' } Measure = { '55 mg' }/>
                </View>
